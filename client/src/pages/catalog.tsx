...
import { ArrowLeft, MapPin, Phone, Clock, MessageCircle, Star, ShieldCheck, Filter, Search, Users } from "lucide-react";
      ...
      <main className="container mx-auto px-4 py-8 flex-grow">
        ...
        {filteredProducts.length > 0 ? (
          ...
          <div className="py-20 text-center bg-slate-50 rounded-[3rem] border border-dashed border-slate-200">
            ...
            <p className="text-slate-500 text-sm mt-2">Попробуйте изменить параметры фильтрации или поиска</p>
            <Button 
              variant="outline" 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-6">
              ...
              <p className="text-slate-400 leading-relaxed text-sm">
                Ваш надежный партнер на рынке «Дордой». Высокое качество и лучшие оптовые цены напрямую от производителя.
              </p>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 group">
                  <div className="bg-blue-600 p-2.5 rounded-xl shadow-lg shadow-blue-900/40 transition-transform group-hover:scale-110">
                    <Phone className="h-5 w-5 text-white" />
                  </div>
                  <a href="tel:+996557650131" className="text-lg font-bold text-white hover:text-blue-400 transition-colors">+996 557 650 131</a>
                </div>
                <div className="flex items-center gap-4 group">
                  <div className="bg-sky-500 p-2.5 rounded-xl shadow-lg shadow-sky-900/40 transition-transform group-hover:scale-110">
                    <MessageCircle className="h-5 w-5 text-white" />
                  </div>
                  <a href="https://t.me/DRUZHBAA_Bot" target="_blank" className="text-lg font-bold text-white hover:text-sky-400 transition-colors">Telegram Bot</a>
                </div>
                <div className="flex items-start gap-4">
                  <div className="bg-slate-800 p-2.5 rounded-xl">
                    <MapPin className="h-5 w-5 text-slate-400" />
                  </div>
                  <p className="text-sm font-medium">Рынок "Дордой", Оберон Форт,<br />30 проход, 2 контейнер</p>
                </div>
              </div>
            </div>
