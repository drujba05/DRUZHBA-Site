        ...
        <div className="relative z-10 container mx-auto px-4 md:px-8">
          <div className="max-w-3xl flex flex-col items-start text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-6 mt-4 w-full sm:w-auto">
              ...
              >
                <a
                  href="https://t.me/DRUZHBAA_Bot?start=order"
                  target="_blank"
              ...
              >
                <a
                  href="https://wa.me/996557650131?text=Здравствуйте,%20я%20хочу%20сделать%20заказ"
                  target="_blank"
                  rel="noopener noreferrer"
                >
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="flex flex-col items-center p-4">
              ...
              <p className="text-muted-foreground text-sm">
                Сертифицированная продукция из лучших материалов
              </p>
            </div>
            <div className="flex flex-col items-center p-4">
              <div className="w-12 h-12 bg-blue-50 rounded-full flex items-center justify-center text-primary mb-3">
              ...
              <p className="text-muted-foreground text-sm">
                Отправка во все регионы в кратчайшие сроки
              </p>
            </div>
            <div className="flex flex-col items-center p-4">
              <div className="w-12 h-12 bg-blue-50 rounded-full flex items-center justify-center text-primary mb-3">
      ...
      <footer className="bg-gray-900 text-gray-300 py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm leading-relaxed max-w-xs">
                Ваш надежный партнер в мире оптовой обуви. Мы предлагаем лучшие
                условия для бизнеса и гарантируем качество каждой пары.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-xs text-gray-500">
            © 2024 DRUZHBA. Все права защищены.
          </div>
        </div>
      </footer>
    </div>
