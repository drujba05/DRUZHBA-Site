...
// ВНИМАНИЕ: Для максимальной скорости LCP лучше использовать прямую ссылку на оптимизированный Cloudinary
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background font-sans">
      ...
      {/* Header / Hero - ОПТИМИЗИРОВАНО ДЛЯ LCP */}
      <header className="relative min-h-[600px] flex items-center text-white overflow-hidden pt-20">
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-8">
          <div className="max-w-3xl flex flex-col items-start text-left">
            <div className="mb-8 mt-4 p-1 bg-black rounded-xl border border-white/20 shadow-2xl">
              <img
                src={logoImage}
                alt="DRUZHBA Logo"
      ...
      {/* Секции товаров - ОПТИМИЗИРОВАНО: картинки грузятся лениво */}
      ...
      {/* ОСТАЛЬНОЙ КОД (Новинки, Преимущества, Футер) ОСТАЕТСЯ ТАКИМ ЖЕ */}
      <footer className="bg-gray-900 text-gray-300 py-12">
        <div className="container mx-auto px-4 text-center">
            <p>© 2026 DRUZHBA. Все права защищены.</p>
        </div>
      </footer>
    </div>
  );
