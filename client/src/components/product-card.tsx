  ...
  return (
    <Card className="overflow-hidden flex flex-col h-full border border-slate-100 shadow-sm bg-white rounded-xl">
      <div className="relative aspect-square bg-slate-50">
        <img src={activePhoto} className="object-cover w-full h-full" alt={product.name} />
        <div className="absolute top-2 left-2 flex flex-col gap-1">
          {product.is_bestseller && <Badge className="bg-orange-500 text-[8px] px-1.5 py-0.5">ХИТ</Badge>}
        </div>
      </div>
